<div class="item active">
	<div class="fill" style="background-image:url({{ asset('imagenes/Droplet_on.jpg') }});"></div>
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/conexionputty.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/SecurityAlert.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/primeringreso.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/cambioContrasena.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/update.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/apache21.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/apache22.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/php5.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/info.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/info2.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/phpinfo.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/postgreSQL.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/pasosBD.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/creacionTablaComandos.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/postgreSQLconf.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/postgreSQLconf2.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/pg_hbaconf.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/pg_hbaconf2.jpg') }});"></div>
	<div class="carousel-caption">
		<h2 class="black">De la siguiente manera</h2>
	</div>
</div>
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/conexionPostgreSQL.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/contraConexion.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/exito.jpg') }});"></div>
	<div class="carousel-caption">
...
<div class="item">
	<div class="fill" style="background-image:url({{ asset('imagenes/tablaGrafico.jpg') }});"></div>
	<div class="carousel-caption">
